...
public class EmployeeUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("E M P L O Y E E S  T A B L E");
        ...
        jtbl_Employees.setFont(new java.awt.Font("Alata", 0, 14)); // NOI18N
    ...
    private void jtxt_SearchKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtxt_SearchKeyTyped
        ...
        try{
            if(search.isEmpty()){
                ...
                ArrayList<Employee> list = empDAO.searchEmployee(search);
                EmployeeTableModel model = new EmployeeTableModel(list);
                jtbl_Employees.setModel(model);
            }
        }
    ...
    private void jtbl_EmployeesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtbl_EmployeesMouseClicked
        ...
        try{
            ...
            String branch = jtbl_Employees.getValueAt(row,0).toString();
            String first = jtbl_Employees.getValueAt(row,2).toString();
            String last = jtbl_Employees.getValueAt(row,3).toString();
            
            Employee emp = new Employee(id,branch,first,last);
            
            EmployeeUI_Update update = new EmployeeUI_Update(emp,empDAO,EmployeeUI.this);
